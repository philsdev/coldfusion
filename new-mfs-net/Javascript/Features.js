Current.ListPage = "index.cfm?event=Admin.Feature.Management";	

Url.Edit = 'index.cfm?event=Admin.Feature.Management';
Url.UpsellProducts = 'index.cfm?event=Admin.Feature.Available'

Form.Edit = "#FeatureEditForm";
...
$().ready( function() {
	...
	$('.OptionAdd').click( function() {
		...
		var ThisOptionHtml = $('#AvailableCategories').children('option:selected').clone();
