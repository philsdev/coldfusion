...
<head>
<cfoutput>
<title>-- #request.SiteName# Admin Section --</title>
<link rel="shortcut icon" href="#Request.Root.Web#favicon.ico" type="image/x-icon" />
...
<div class="MainBorder">
	<div id="banner">
		...
		<a href="index.cfm?event=Admin.HomePage" title="HOME">
			<img border="0" src="#Request.Root.Web#images/logo/logo-admin.gif" style="display:inline; position:absolute; top:10px; left:10px; ">
		</a>
		</cfoutput>		
		<cfif StructKeyExists(Session, "Admin") AND Session.Admin iS "Yes">
			<cfparam name="Session.NavSection" default="" />
						...
						<cfoutput query="session.SectionQuery" group="GroupName">
							<optgroup label="#GroupName#">
								<cfoutput>
									...
									<CFIF Session.NavSection EQ EventName>selected="selected"</CFIF>>#sectionname#</option>
								</cfoutput>
							</optgroup>
						</cfoutput>
					</select>               
