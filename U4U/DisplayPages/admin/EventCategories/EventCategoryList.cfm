...
<cfinclude template="inc_MainNavigation.cfm" />
	<div class="TabbedPanelsContentGroup">
		<div class="TabbedPanelsContent">
			...
			<div id="navigation" >
				<form action="javascript:void(0)" method="post" id="EventCategorySearch">
					<h2 class="sectionTitle">Search Event Categories</h2>
					<ul class="form">
						<li>
							<label>Title:</label>
			...
			<div id="content">
				<div class="formContainer"><cfoutput>#Request.EventCategoryGrid#</cfoutput></div>
			</div>
